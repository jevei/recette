...
paul = User.create!(nom: "Paul", password: "Paul12", prenom: "Tremblay", email: "paul@tremblay.com", isAdmin: true)
george = User.create!(nom: "George", password: "George", prenom: "Germain", email: "george@germain.com")
jacque = User.create!(nom: "Jacque", password: "Jacque", prenom: "Germain", email: "jacque@germain.com")
daniel = User.create!(nom: "Daniel", password: "Daniel", prenom: "Peterson", email: "daniel@peterson.com")
robert = User.create!(nom: "Robert", password: "Robert", prenom: "Skywalker", email: "robert@skywalker.com")
